...
;// CONCATENATED MODULE: ./src/api/orders/data.ts
...
const orders = [
    {
        ...
        createdAt: subDays_default()(subHours_default()(now, 4), 1).getTime(),
        currency: "$",
        customer: {
    ...
    },
    {
        ...
        createdAt: subDays_default()(subHours_default()(now, 7), 1).getTime(),
        currency: "$",
        customer: {
            address1: "Street John Wick, no. 7",
            address2: "House #25",
    ...
    },
    {
        ...
        createdAt: subDays_default()(subHours_default()(now, 2), 2).getTime(),
        currency: "$",
        customer: {
            address1: "Street John Wick, no. 7",
            address2: "House #25",
    ...
    },
    {
        ...
        createdAt: subDays_default()(subHours_default()(now, 3), 5).getTime(),
        currency: "$",
        customer: {
            address1: "Street John Wick, no. 7",
            address2: "House #25",
    ...
    },
    {
        ...
        createdAt: subDays_default()(subHours_default()(now, 1), 6).getTime(),
        currency: "$",
        customer: {
            address1: "Street John Wick, no. 7",
            address2: "House #25",
    ...
    },
    {
        ...
        createdAt: subDays_default()(subHours_default()(now, 3), 7).getTime(),
        currency: "$",
        customer: {
            address1: "Street John Wick, no. 7",
            address2: "House #25",
    ...
    },
    {
        ...
        createdAt: subDays_default()(subHours_default()(now, 6), 8).getTime(),
        currency: "$",
        customer: {
            address1: "Street John Wick, no. 7",
            address2: "House #25",
    ...
    },
    {
        ...
        createdAt: subDays_default()(subHours_default()(now, 7), 8).getTime(),
        currency: "$",
        customer: {
            address1: "Street John Wick, no. 7",
            address2: "House #25",
    ...
    },
    {
        ...
        createdAt: subDays_default()(subHours_default()(now, 6), 9).getTime(),
        currency: "$",
        customer: {
            address1: "Street John Wick, no. 7",
            address2: "House #25",
    ...
    },
    {
        ...
        createdAt: subDays_default()(subHours_default()(now, 3), 10).getTime(),
        currency: "$",
        customer: {
            address1: "Street John Wick, no. 7",
            address2: "House #25",
    ...
    logs: [
        {
            ...
            createdAt: subHours_default()(Date.now(), 18).getTime(),
            message: "Stripe charge complete (Charge ID: 5ecb8a6879877087d4aa2690)"
        },
        {
            id: "41845b427db837502b4d6a57",
            createdAt: subHours_default()(Date.now(), 21).getTime(),
...
;// CONCATENATED MODULE: ./src/api/orders/index.ts
...
class OrdersApi {
    getOrders(request = {}) {
        ...
        let data = (0,deep_copy/* deepCopy */.p)(orders);
    ...
    getOrder(request) {
        return Promise.resolve((0,deep_copy/* deepCopy */.p)(order));
    }
}
